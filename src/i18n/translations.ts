...
const en: Dict = {
  ...
  routine: {
    screenTitle: 'Baby Routine',
    analyzing: 'Analysing baby data...',
    errorTitle: "Couldn't load data",
    errorDefault: 'Failed to load recommendation.',
    priorityRoutine: 'Routine',
    priorityModerate: 'Moderate',
    priorityUrgent: 'Urgent',
    vitalsTitle: 'Live Vitals',
    vitalTemp: 'Temp',
    vitalOxygen: 'Oxygen',
    vitalPulse: 'Pulse',
    vitalBreath: 'Breath',
    vitalStatusHigh: 'High',
    vitalStatusLow: 'Low',
    vitalStatusNormal: 'Normal',
    feverAlert: 'Attention: High fever detected',
    aiConfidenceTitle: 'AI Confidence',
    aiConfidenceDesc: 'Model confidence in this recommendation',
    cryAnalysisTitle: 'Cry Analysis',
    cryIntensity: 'Intensity',
    cryConfidence: 'Confidence',
    historyTitle: 'Pattern History (Last 24 h)',
    historyEventsToday: 'Events\ntoday',
    historyPatternDetected: 'Pattern\ndetected',
    historyNoPattern: 'No pattern\ndetected',
    historyRepeatedIssue: 'Repeated\nissue',
    historyLastEvent: 'Last similar event: {{time}}'
  },
  onboarding: {
...
const ar: Dict = {
  ...
  routine: {
    screenTitle: 'روتين الطفل',
    analyzing: 'جاري تحليل بيانات الطفل...',
    errorTitle: 'تعذر تحميل البيانات',
    errorDefault: 'فشل تحميل التوصية.',
    priorityRoutine: 'روتينية',
    priorityModerate: 'متوسطة',
    priorityUrgent: 'عاجلة',
    vitalsTitle: 'العلامات الحيوية',
    vitalTemp: 'الحرارة',
    vitalOxygen: 'الأكسجين',
    vitalPulse: 'النبض',
    vitalBreath: 'التنفس',
    vitalStatusHigh: 'مرتفع',
    vitalStatusLow: 'منخفض',
    vitalStatusNormal: 'طبيعي',
    feverAlert: 'تنبيه: تم اكتشاف حمى شديدة',
    aiConfidenceTitle: 'ثقة الذكاء الاصطناعي',
    aiConfidenceDesc: 'مدى ثقة النموذج في هذه التوصية',
    cryAnalysisTitle: 'تحليل البكاء',
    cryIntensity: 'الشدة',
    cryConfidence: 'الثقة',
    historyTitle: 'سجل الأنماط (آخر 24 ساعة)',
    historyEventsToday: 'أحداث\nاليوم',
    historyPatternDetected: 'تم رصد\nنمط',
    historyNoPattern: 'لا يوجد\nنمط',
    historyRepeatedIssue: 'مشكلة\nمتكررة',
    historyLastEvent: 'آخر حدث مشابه: {{time}}'
  },
  growthBands: {
    m0_1: '0–1 شهر',
    m2_3: '2–3 أشهر',
